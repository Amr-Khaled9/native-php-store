...
if ($_GET) {
    if (isset($GET['sub'])) {
        if (is_numeric($_GET['sub'])) {
            ...
            if ($subcategoriesData) {
                ...
                $productResult = $productObject->getProductsBySub();
            } else {
    ...
    // print_r($productResult);print_r($_GET);die;
                                        ...
                                        <div class="product-wrapper">
                                            <div class="product-img">
                                                <a href="product-details.php?id=<?php echo $value['id'] ?>">
                                                    <img alt="" src="assets/img/product/<?php echo $value['image'] ?>">
                                                </a>
                                            ...
                                            <div class="product-content text-left">
                                                <div class="product-hover-style">
                                                    <div class="product-title">
                                                        <h4>
                                                            <a href="product-details.php"><?php echo $value['name_en'] ?></a>
                                                        </h4>
                                                    </div>
                                                    <div class="cart-hover">
                                                        <h4><a href="product-details.php?id=<?php echo $value['id'] ?>">+ Add to cart</a></h4>
                                                    </div>
                                                </div>
                                                <div class="product-price-wrapper">
                                                    <span>$100.00 -</span>
                                                    <span class="product-price-old?id=<?php echo $value['id'] ?>"><?php echo $value['price'] ?> </span>
                                                </div>
                                            </div>
                                            <div class="product-list-details">
                                                <h4>
                                                    <a href="product-details.php?id=<?php echo $value['id'] ?>">Nature Close Tea</a>
                                                </h4>
                                                <div class="product-price-wrapper">
                                                    <span>$100.00</span>
                                                    <span class="product-price-old">$120.00 </span>
                                                </div>
                                                <p><?php echo $value['desc_en'] ?></p>
                    ...
                    <div class="shop-widget">
                        ...
                        <div class="shop-catigory">
                            <ul id="faq">
                                <?php
                                if (!empty($categories)) {
                                    // $categories = $resultCategory->fetch_all();
                                    foreach ($categories as $key => $category) {
                                ?>
                                        <li> <a data-toggle="collapse" data-parent="#faq" href="#shop-catigory-<?php echo $key ?>">
                                                <?php echo $category['name_ar'] ?> <i class="ion-ios-arrow-down"></i></a>
                                            <ul id="shop-catigory-<?php echo $key ?>" class="panel-collapse collapse show">
                                                <?php
                                                $subcategoreObject->setCategory_id($category['id']);
                                                $resultSubcategore = $subcategoreObject->getSubsByCats();
                                                if ($resultSubcategore) {
                                                    $subcategoreObject->setCategory_id($category['id']);
                                                    $subcategories = $subcategoreObject->getSubsByCats();
